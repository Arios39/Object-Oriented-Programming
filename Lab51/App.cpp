...
App::App(int argc, char** argv, int width, int height, const char* title): GlutApp(argc, argv, width, height, title){
    ...
    background = new TexRect("/Users/andresrios/Lab5/bg.png", -2, 1, 4, 2);
    background2 = new TexRect("/Users/andresrios/Lab5/bg.png", 2, 1, 4, 2);
    bobcat = new AnimatedRect("/Users/andresrios/Lab5/cat.png", 4, 2, 100, true, false, -0.04, -0.25, 0.8, 0.5);
    bobcat->playLoop();
